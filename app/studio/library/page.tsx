    ...
    if (view === 'focus') {
        return (
            <main className="min-h-screen bg-[#F8F7F5] font-serif">
                ...
                <div className="bg-[#4e3629]/5 border-b border-[#4e3629]/10 px-6 py-3">
                    <div className="max-w-4xl mx-auto flex items-center gap-3">
                        <Info className="w-5 h-5 text-[#4e3629]/60 shrink-0" />
                        <p className="text-sm font-sans text-[#4e3629]/80 font-medium">
                            Listen to each name to activate the <span className="font-bold">Approve</span> button. This ensures pronunciation accuracy.
                        </p>
                    </div>
                </div>
